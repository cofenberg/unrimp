...
class static_huffman_data_model {
 ...
 // TODO(co) Odd false positive Visual Studio 2017 compiler error: "error C2248: 'crnd::static_huffman_data_model::prepare_decoder_tables': cannot access private member declared in class 'crnd::static_huffman_data_model'"
 public:
