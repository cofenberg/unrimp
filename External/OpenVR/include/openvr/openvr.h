...
namespace vr
{
	...
	*/
	...
	VR_INTERFACE uint32_t (VR_CALLTYPE *VR_InitInternal2)( EVRInitError *peError, EVRApplicationType eApplicationType, const char *pStartupInfo );	// TODO(co) Changed for dynamic linking
